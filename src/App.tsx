      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex gap-4">
            ...
            <a href="mailto:chris@bickrs.com" className="p-4 bg-slate-950 border border-slate-900 text-slate-500 hover:text-cyan-500 hover:border-cyan-500 transition-all">
